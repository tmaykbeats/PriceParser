from peewee import Model, CharField, FloatField, DateTimeField, IntegerField, BooleanField, SqliteDatabase, ForeignKeyField, TextField
...
def init_db():
    db.connect()
    db.create_tables([Product, Subscription, PriceHistory, Basket, BasketItem], safe=True)
    db.close()